					...
					switch(type) {
						case 1: 
							...
							for(int i=0;i<numberOfBook;i++) {
								...
								Inventory.addToInventory(new LiteratureBook(name,author,price,amount,republish,genre));
							}
							break;
						case 2: 
							...
							for(int i=0;i<numberOfBook;i++) {
								...
								System.out.print("Enter the genre: ");
								String genre = input.nextLine();
								Inventory.addToInventory(new ScienceBook(name,author,price,amount,publishYear,genre));
							}
							break;
						case 3:
							...
							for(int i=0;i<numberOfBook;i++) {
								...
								System.out.print("Enter the genre: ");
								String genre = input.nextLine();
								Inventory.addToInventory(new ForeignBook(name,author,price,amount,iSBN,genre));
							}
							break;
						}
					break;
