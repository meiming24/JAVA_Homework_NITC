			...
			case 1:
				...
				case 1:
					...
					for(int i=0;i<numApple;i++) {
						...
						System.out.print("Enter vitamin: ");
						String vitamin=in.nextLine();
						Inventory.addToInventory(new Apple(name,price,quantity,sugar,vitamin));
					}
					break;
				case 2:
					...
					for(int i=0;i<numOrange;i++) {
						...
						System.out.print("Enter vitamin: ");
						String vitamin=in.nextLine();
						Inventory.addToInventory(new Orange(name,price,quantity,weight,vitamin));
					}
					break;
				case 3:
					...
					for(int i=0;i<numBanana;i++) {
						...
						System.out.print("Enter vitamin: ");
						String vitamin=in.nextLine();
						Inventory.addToInventory(new Banana(name,price,quantity,kali,vitamin));
					}
					break;
				}
